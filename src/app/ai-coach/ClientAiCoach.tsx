// src/app/ai-coach/ClientAiCoach.tsx
// Client-side chat UI (streaming) for the protected /ai-coach route.
          ...
          {messages.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-8">
                I know your workout history and can build personalised programs, analyse your progress, and answer any fitness question.
              </p>
          ...
          {error && (
            <div className="flex flex-col items-center gap-3">
              ...
              <button
                ...
                className="text-sm px-4 py-2 rounded-xl border border-red-200 dark:border-red-900/50 text-red-700 dark:text-red-200 bg-red-50 dark:bg-red-950/30 hover:bg-red-100 dark:hover:bg-red-950/50 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Try again
              </button>
            </div>
