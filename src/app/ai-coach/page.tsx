      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-3xl mx-auto flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900">FitAI Coach</p>
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          {messages.length === 0 && (
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Your AI Fitness Coach</h2>
              <p className="text-gray-500 text-sm mb-8">I know your workout history and can build personalised programs, analyse your progress, and answer any fitness question.</p>
              <div className="grid grid-cols-2 gap-2 max-w-lg mx-auto">
                {suggestions.map(s => (
                  <button
                    key={s}
                    onClick={() => sendMessage(s)}
                    className="text-left text-sm text-gray-700 border border-gray-200 rounded-xl px-4 py-3 hover:bg-gray-50 hover:border-gray-300 transition-colors"
                  >
                    {s}
                  </button>
                ))}
