    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            ...
            <a href="/ai-coach"    className="text-sm text-gray-600 hover:text-gray-900">AI Coach</a>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Let's crush today's workout.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/workouts/new" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
              + Log workout
            </a>
          </div>
          ...
          {recentWorkouts.length === 0 ? (
            ...
            <div className="space-y-3">
              {recentWorkouts.map(workout => {
                ...
                return (
                  <div key={workout.id} className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50">
